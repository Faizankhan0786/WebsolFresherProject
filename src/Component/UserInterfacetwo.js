...
const classes = useStyles();
   ...
   <Grid item xs={12} sm={6} style={{display:'flex', justifyContent:'center', alignItems:'center'}} >
     ...
     <Grid item xs={12}  style={{display:'flex', justifyContent:'center', alignItems:'center'}} >
                        <AddCircleOutlineIcon onClick={()=>handleClick()} fullWidth variant="contained" color="primary" >Add</AddCircleOutlineIcon>
                    </Grid>

                    <Grid item xs={12}  style={{display:'flex', justifyContent:'center', alignItems:'center'}}>
                        <RemoveCircleOutlineIcon fullWidth variant="contained" color="secondary">Reset</RemoveCircleOutlineIcon>
                    </Grid>
                    <Grid item xs={12} sm={6} style={{display:'flex', justifyContent:'center', alignItems:'center'}} >
